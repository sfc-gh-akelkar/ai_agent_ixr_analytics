...
-- ============================================================================
-- UPDATE PROVIDER CHURN RISK BASED ON PATIENT ENGAGEMENT (H3 Correlation)
-- Creates the flywheel: High patient engagement = Lower provider churn risk
-- ============================================================================
...
FROM (
    SELECT 
        pt.PROVIDER_ID,
        AVG(pt.ENGAGEMENT_SCORE) as avg_eng
    FROM PATIENTS pt
