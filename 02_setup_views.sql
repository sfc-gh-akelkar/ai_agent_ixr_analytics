...
SELECT 
    ...
    -- Time Period
    months.OUTCOME_MONTH,
    YEAR(months.OUTCOME_MONTH) AS OUTCOME_YEAR,
    MONTHNAME(months.OUTCOME_MONTH) AS OUTCOME_MONTH_NAME,
    QUARTER(months.OUTCOME_MONTH) AS OUTCOME_QUARTER,
...
LEFT JOIN monthly_engagement e 
    ...
    AND months.OUTCOME_MONTH = e.ENGAGEMENT_MONTH
LEFT JOIN PATIENT_OUTCOMES o 
    ON p.NPI = o.PROVIDER_NPI 
    AND months.OUTCOME_MONTH = o.OUTCOME_MONTH
