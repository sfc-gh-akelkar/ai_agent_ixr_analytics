...
CREATE OR REPLACE SCHEMA RAW_DATA;      -- Ingested telemetry
CREATE OR REPLACE SCHEMA ANALYTICS;     -- Feature engineering, predictions
CREATE OR REPLACE SCHEMA OPERATIONS;    -- Operational tables (alerts, workflows)
